...
export const CONFLICT_DEFINITIONS: Record<string, { category: ConflictCategory; label: string }> = {
  ...
  HOME_DEPOT_NOT_IN_DEPOT: { category: 'location', label: 'Nicht im Heimdepot.' },
  ...
  SERVICE_START_LOCATION_MISSING: { category: 'location', label: 'Dienstanfang: Ort fehlt.' },
  SERVICE_END_LOCATION_MISSING: { category: 'location', label: 'Dienstende: Ort fehlt.' },
  BREAK_LOCATION_MISSING: { category: 'location', label: 'Pause: Ort fehlt.' },
  SHORT_BREAK_LOCATION_MISSING: { category: 'location', label: 'Kurzpause: Ort fehlt.' },
