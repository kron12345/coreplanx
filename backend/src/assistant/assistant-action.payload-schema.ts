...
export const ROOT_FIELDS_BY_ACTION: Record<string, string[]> = {
  ...
  create_activity_type: ['action', 'activityType', 'activityTypes', 'items', 'reason'],
  create_activity_template: ['action', 'activityTemplate', 'activityTemplates', 'items', 'reason'],
  create_activity_definition: ['action', 'activityDefinition', 'activityDefinitions', 'items', 'reason'],
  create_layer_group: ['action', 'layerGroup', 'layerGroups', 'items', 'reason'],
  update_activity_type: ['action', 'target', 'patch', 'reason'],
  ...
  delete_activity_type: ['action', 'target', 'reason'],
  ...
  update_translations: ['action', 'translations', 'translation', 'items', 'locale', 'reason'],
  delete_translation_locale: ['action', 'locale', 'target', 'reason'],
  create_custom_attribute: ['action', 'customAttribute', 'customAttributes', 'items', 'reason'],
