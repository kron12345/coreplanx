...
const COMMON_REQUIRED: OrderingRequiredAttributeDefinition[] = [
  ...
  {
    key: 'reason_of_reference',
    label: 'ReasonOfReference',
    scope: 'provided',
    path: 'reasonOfReference',
  },
  {
    key: 'validity_date',
    label: 'Gültigkeit',
  ...
  {
    key: 'traffic_type_code',
    label: 'TrafficTypeCode',
    scope: 'provided',
    path: 'trafficTypeCode',
  },
  {
    key: 'service_type',
    label: 'Fahrtyp',
  ...
  },
  {
    ...
    label: 'Distributionsliste',
    scope: 'provided',
    path: 'distributionList',
  },
  {
    key: 'free_processing_reason',
    label: 'Grund kostenlose Bearbeitung',
    scope: 'provided',
    path: 'freeProcessingReason',
  },
  {
