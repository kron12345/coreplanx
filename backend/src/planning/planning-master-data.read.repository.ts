...
export class PlanningMasterDataReadRepository {
  ...
  async loadMasterData(): Promise<MasterDataSets> {
    ...
    const [
      ...
      this.loadJsonCollection<StationArea>(
        'topology_station_area',
        'station_area_id',
      ),
      this.loadJsonCollection<Track>('topology_track', 'track_key'),
      this.loadJsonCollection<PlatformEdge>(
        'topology_platform_edge',
        'platform_edge_id',
      ),
      this.loadJsonCollection<Platform>('topology_platform', 'platform_key'),
      this.loadJsonCollection<Siding>('topology_siding', 'siding_key'),
