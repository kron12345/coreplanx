# CorePlanX – Auftragsmanagement & Fahrplan  
## Begleitdokument für Fachanwender:innen und Kund:innen

Dieses Dokument begleitet CorePlanX mit den Modulen Auftragsmanagement und Fahrplanmanager.  
...
> - der technischen Produktspezifikation **„Auftragsmanagement – Produktspezifikation“** (`docs/coreplanx-order-management-spec.md`).  
...
- Das **Fachkonzept / die Produktspezifikation** (`docs/coreplanx-order-management-spec.md`) beschreibt dieselben Bereiche technisch: Komponenten, Services, Datenstrukturen, Statuslogik und Integrationen.
...
Das vollständige Fachkonzept bleibt unverändert in `docs/coreplanx-order-management-spec.md` bestehen und kann dort im Detail nachgelesen werden.
